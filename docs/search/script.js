...
var removeStopWordsCheckbox = document.getElementById(
...
var updateBooksTable = function (books) {
  ...
  for (var i = 0, length = books.length; i < length; i++) {
    ...
    let imgurl = book["og:image"];

    let url = book["og:url"];
    isbnColumn.innerHTML =
      "<a href='" +
      url +
      "'><img src='" +
      imgurl +
      "' height='144' width='96'></img></a>";

    var titleColumn = document.createElement("td");
    titleColumn.innerHTML = "<a href='" + url + "'>" + book.title + "</a>";
